...
- **追補**: [`2026-08-timeline-editing-ux-audit.md`](2026-08-timeline-editing-ux-audit.md) — 本資料への第三者監査（正確性の検証・未記載の機能欠落・不足観点カタログ・ADR-0034 論点の追補）。**ADR-0034 は両方を材料にする**こと。
- **追補2**: [`2026-08-video-editor-user-reviews.md`](2026-08-video-editor-user-reviews.md) — ツールを限定しないユーザーレビュー横断（褒められる型 P1〜P7／不満の型 C1〜C11 と、うちへの含意）。
