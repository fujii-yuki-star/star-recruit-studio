 ...
 *
 * ⚠️ **版の一覧はここに置かない**（#513 の方針・α-6 出口監査 🟡で場面形式にそろえた）＝
 * 一覧は `timeline-project.schema.json` の `schemaVersion.description` **1か所**にある。
 * ここに写すと**必ずずれる**（実際、1.8→1.9〔#264〕が抜け、現行が 1.10 なのに「1.0→1.9」のままだった）。
 *
