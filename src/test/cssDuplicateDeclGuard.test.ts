...
/**
 * 各スタイルシートが持つ宣言の数の**下限**（実測 2026-09-10・`timeline.css` は 2026-09-15 に更新）。
 *
 * ⚠️ **下限にする**＝足すたびに数を直させない（そこは差分で見える）。**減るとき**だけ立ち止まる。
 * ⚠️ **規則をわざと消したら、この数も一緒に下げる**（下げた事実が差分に残るのが狙い）。
 * ⚠️ **下限が実態から離れすぎても立ち止まる**＝離れたままだと「まとめて消しても通る」に戻る。
 *   実際この回（#1159）で 223→255 まで離れ、ここが赤くなって更新した＝**留める意味があった**。
 */
