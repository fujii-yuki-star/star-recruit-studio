...
export const editBlockedMessage: Record<EditBlockedReason, string> = {
  ...
  TIMELINE_EDIT_CURVED_EASING: "動きの途中では分けられません。動きの折り返し（キーフレーム）の位置か、動きの無い所で分けてください",
  TIMELINE_EDIT_PLAYING: "再生を止めてから使えます",
  TIMELINE_EDIT_UNSPLITTABLE: "この部品は分けられません。読み上げと、それに合わせている字幕は、切ると文と音がずれます",
  TIMELINE_EDIT_SPLIT_OUTSIDE: "その位置では分けられません。再生位置を部品の中（両側が0.1秒以上残る所）へ動かしてください",
  TIMELINE_EDIT_MULTI_SELECTION: "まとめて動かすことはまだできません。1つだけ選んでから動かしてください",
